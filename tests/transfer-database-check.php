...
try {
 ...
 $from = array( 'site_url' => 'https://source.example', 'home_url' => 'https://source.example', 'root_path' => '/Users/example/source', 'prefix' => 'wp_' ); $to = array( 'site_url' => 'https://destination.example', 'home_url' => 'https://destination.example', 'root_path' => '/srv/www/destination', 'prefix' => 'dst_' );
