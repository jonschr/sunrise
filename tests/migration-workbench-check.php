...
try {
 ...
 wp_set_current_user( 0 ); $assert( is_wp_error( Sunrise\save_migration_draft( $draft ) ) && is_wp_error( Sunrise\migration_status() ) && is_wp_error( Sunrise\migration_sync() ) ); wp_set_current_user( $owner );
