...
function installation_resolve( $kind, $expected_id, $confirmed = false ) {
	...
	try {
		...
		$names = array( 'sunrise_agents', 'sunrise_agent', 'sunrise_agent_pause', 'sunrise_agent_revoked', 'sunrise_policy', 'sunrise_last_refresh', 'sunrise_remote_job_fence', 'sunrise_automatic_update_failures', 'sunrise_error_groups', 'sunrise_error_capture_lock', 'sunrise_migration_pairs', 'sunrise_database_active', 'sunrise_database_last', 'sunrise_control_reauth_required' );
